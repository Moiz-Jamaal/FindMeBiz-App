...
class SellerDashboardView extends GetView<SellerDashboardController> {
      ...
      child: CustomScrollView(
        slivers: [
          ...
          Obx(() {
            ...
            if (!controller.isProfilePublished.value) {
              return _buildProfileStatusCard();
            }
            return controller.hasActiveSubscription 
                ? _buildSubscriptionCard()
                : _buildPublishedOnlyCard();
          }),
          Obx(() {
            if (controller.isLoading.value) {
  ...
  Widget _buildPublishedOnlyCard() {
    return SliverToBoxAdapter(
      child: Container(
        margin: const EdgeInsets.all(AppConstants.defaultPadding),
        child: Card(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            'To add products, subscribe to a plan',
                            style: Get.textTheme.bodyMedium?.copyWith(
                              color: Colors.white.withValues(alpha: 0.9),
                      ...
                      if (!Platform.isIOS)
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () => Get.toNamed('/seller-publish'),
                            style: ElevatedButton.styleFrom(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              final Uri url = Uri.parse('https://findmebiz.com');
                              if (!await canLaunchUrl(url)) {
                                Get.snackbar(
                                  'Error',
                                  'Could not open website. Please visit findmebiz.com manually.',
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  'Your profile is live and you can add products',
                  style: Get.textTheme.bodyMedium?.copyWith(
                    color: Colors.white.withValues(alpha: 0.9),
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (controller.subscriptionEndDate != null) ...[
                        const SizedBox(height: 8),
                        Row(
                          children: [
                            Icon(
                            ...
                            Text(
                              'Valid until ${controller.subscriptionEndDate}',
                              style: Get.textTheme.bodySmall?.copyWith(
                                color: Colors.white.withValues(alpha: 0.8),
                              ),
                            ),
